defmodule AshA2A.Chicago.Courts.ExactIdentity do
  ...
  `[:ash_a2a, :chicago, :standing, :issued]`,
  ...
  def falsifiers do
    [
      ...
      Falsifier.new!(
        ...
        survival_evidence:
          "verified outcome=match; chicago.standing.issued with verification match and a " <>
        ...
        outcome_predicate:
          {:all,
           [
             ...
             {:observed, "chicago.standing.issued", %{"subject_verification" => "match"}},
             {:not_observed, "chicago.standing.issued", %{"standing" => "REFUSED"}},
             {:precedes, "chicago.subject.verified", "chicago.standing.issued", "subject"}
           ]}
      ),
      Falsifier.new!(
        id: "CHI-ID-009",
    ...
    Falsifier.new!(
      ...
      survival_evidence:
        "no chicago.subject.verified mismatch naming #{field}; or no REFUSED " <>
          "chicago.standing.issued; or standing issued with verification match; or standing " <>
      ...
      outcome_predicate:
        {:any,
         [
           ...
           {:not_observed, "chicago.standing.issued",
            %{"standing" => "REFUSED", "subject_verification" => "mismatch"}},
           {:observed, "chicago.standing.issued", %{"subject_verification" => "match"}},
           {:not, {:precedes, "chicago.subject.verified", "chicago.standing.issued", "subject"}}
         ]}
    )
  end
  ...
  def ocel_mappings do
    [
      ...
      Mapping.new!(
        event: [:ash_a2a, :chicago, :standing, :issued],
        activity: "chicago.standing.issued",
        source: __MODULE__,
        objects: fn _m, meta ->
          uniq_refs([
        ...
        attributes: fn _m, meta ->
          Map.take(meta, [:standing, :subject_verification, :claimed_profile, :run_id])
        end
      ),
      Mapping.new!(
