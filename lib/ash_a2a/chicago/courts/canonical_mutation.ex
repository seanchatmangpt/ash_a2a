defmodule AshA2A.Chicago.Courts.CanonicalMutation do
  ...
  def falsifiers do
    [
      ...
      declare(6, :negative,
        ...
        attempt_evidence: "ir_admission.decision observed",
        survival_evidence:
          "ir_admission.decision outcome=admitted or ontology.project outcome=projected",
        guard: "Admission.admit/2 fence + verbatim source_quote grounding",
        failure_class: :admission_failure,
        attempt_predicate: {:observed, "ir_admission.decision"},
        outcome_predicate:
          {:any, [{:observed, "ir_admission.decision", %{"outcome" => "admitted"}}, @projected]}
      ),
      declare(7, :positive_control,
        ...
        survival_evidence: "ir_admission.decision admitted and ontology.project projected",
        attempt_predicate: @project,
        outcome_predicate:
          {:all, [{:observed, "ir_admission.decision", %{"outcome" => "admitted"}}, @projected]}
      ),
      declare(8, :negative,
        invariant:
  ...
  defp shortcuts(ctx, f) do
    ...
    [
      ...
      Result.negative(f.(6),
        attempt_observed?: F.observed?(ctx, f.(6), "ir_admission.decision"),
        forbidden_outcome_observed?:
          match?({:ok, _}, r6) or
            F.observed?(ctx, f.(6), "ir_admission.decision", %{"outcome" => "admitted"}) or
