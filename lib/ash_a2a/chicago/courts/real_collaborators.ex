defmodule AshA2A.Chicago.Courts.RealCollaborators do
  ...
  @grant "authority.grant.decision"
  ...
  def falsifiers do
    [
      Falsifier.new!(
        ...
        attempt_evidence:
          "authority.grant.decision under the legacy policy granted a fresh ungranted nonce principal; inventory emitted",
        survival_evidence:
      ...
      Falsifier.new!(
        ...
        forbidden_outcome:
          "inventory reports authority fail-closed, or no :authority_not_real_boundary violation",
        attempt_evidence:
          "authority.grant.decision under :broker policy with the always-grant broker granted the nonce principal",
        survival_evidence:
          "inventoried authority_fail_closed=true, or no violation code=authority_not_real_boundary",
        guard:
      ...
      Falsifier.new!(
        ...
        attempt_evidence:
          "authority probe denied under :broker; real GraphLaw host executed; store really restarted; scan ran over lib,test",
        survival_evidence:
        ...
        attempt_predicate:
          {:all,
           [
             {:observed, @grant, %{"policy" => "broker", "outcome" => "denied"}},
             {:observed, @batch, %{"outcome" => "ok"}},
             {:observed, @probe, %{"stage" => "restart", "outcome" => "restarted"}},
  ...
  def ocel_mappings do
    [
      ...
      Mapping.new!(
        event: [:ash_a2a, :authority, :grant, :decision],
        activity: @grant,
        source: __MODULE__,
        objects: fn _m, meta ->
          [
        ...
        attributes: fn _m, meta -> attrs(Map.take(meta, [:policy, :broker, :outcome])) end
      ),
      Mapping.new!(
