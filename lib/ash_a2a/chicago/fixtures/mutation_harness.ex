  ...
  def falsifiers do
    [
      ...
      neg("004",
        ...
        guard: "Broker.InMemory standing?/2 revoked-set check",
        failure_class: :authority_failure,
        attempt_predicate: {:observed, "brce.admission"},
        outcome_predicate: @actuated
      ),
      neg("005",
        ...
        boundary: "AshA2A.CommandBus prepare_receipt_anchor/3 before actuate",
        ...
        guard: "CommandBus.prepare_receipt_anchor/3",
