defmodule AshA2A.Semantic.Refusal do
  ...
  **not** rename, wrap, or replace any of them.
  ...
  @mapping %{
    ...
    policy_population_digest_mismatch: :refused_identity,
    policy_population_rdf_identity_mismatch: :refused_identity,
    ...
    policy_population_custom_rdf_predicate: :refused_namespace,
    policy_population_custom_rdf_class: :refused_namespace,
    ...
    invalid_policy_population: :refused_structure,
    invalid_policy_population_rdf: :refused_structure,
    invalid_population_kind: :refused_structure,
    population_requires_member: :refused_structure,
    homogeneous_population_requires_one_phenotype: :refused_structure,
    adaptive_population_requires_reaction_norm: :refused_structure,
    invalid_population_weight: :refused_structure,
    ...
    population_authority_smuggling: :refused_authority,
    ...
    # --- RFC-SA2A-001/002 merge-round codes (v26.9.16) --------------------
    # Classified by the transition each refuses; engine/host/tooling
    # unavailability is BLOCKED_RESOURCE, never a semantic refusal.
    # BLOCKED_RESOURCE
    artifact_not_found: :blocked_resource,
    bad_name: :blocked_resource,
    conformance_vectors_missing: :blocked_resource,
    conformance_vectors_missing_digest: :blocked_resource,
    construct_manufacturer_failed: :blocked_resource,
    engine_input_missing: :blocked_resource,
    fixture_not_found: :blocked_resource,
    graphlaw_abi_failure: :blocked_resource,
    graphlaw_arity_mismatch: :blocked_resource,
    graphlaw_bad_response: :blocked_resource,
    graphlaw_call_error: :blocked_resource,
    graphlaw_call_failed: :blocked_resource,
    graphlaw_call_raised: :blocked_resource,
    graphlaw_driver_error: :blocked_resource,
    graphlaw_driver_exit: :blocked_resource,
    graphlaw_driver_not_found: :blocked_resource,
    graphlaw_error: :blocked_resource,
    graphlaw_host_bad_descriptor: :blocked_resource,
    graphlaw_host_bad_response: :blocked_resource,
    graphlaw_host_executable_not_found: :blocked_resource,
    graphlaw_host_exited: :blocked_resource,
    graphlaw_host_failed: :blocked_resource,
    graphlaw_host_not_available: :blocked_resource,
    graphlaw_host_not_built: :blocked_resource,
    graphlaw_host_port_closed: :blocked_resource,
    graphlaw_host_timeout: :blocked_resource,
    graphlaw_instantiation_failed: :blocked_resource,
    graphlaw_manifest_unreadable: :blocked_resource,
    graphlaw_node_not_found: :blocked_resource,
    graphlaw_non_binary_payload: :blocked_resource,
    graphlaw_non_json: :blocked_resource,
    graphlaw_non_json_stdout: :blocked_resource,
    graphlaw_not_started: :blocked_resource,
    graphlaw_result_arity_mismatch: :blocked_resource,
    graphlaw_session_result_count_mismatch: :blocked_resource,
    graphlaw_shim_not_found: :blocked_resource,
    graphlaw_timeout: :blocked_resource,
    graphlaw_unavailable: :blocked_resource,
    graphlaw_unexpected_host_payload: :blocked_resource,
    graphlaw_unexpected_in_beam_result: :blocked_resource,
    graphlaw_unexpected_payload: :blocked_resource,
    graphlaw_unexpected_result_arity: :blocked_resource,
    graphlaw_unknown_function: :blocked_resource,
    graphlaw_unsupported_function: :blocked_resource,
    graphlaw_wasm_missing: :blocked_resource,
    graphlaw_wasm_not_available: :blocked_resource,
    graphlaw_wasm_not_vendored: :blocked_resource,
    graphlaw_wasm_unreadable: :blocked_resource,
    host_failed: :blocked_resource,
    host_non_json_stdout: :blocked_resource,
    malformed_result: :blocked_resource,
    manifest_non_json: :blocked_resource,
    manifest_not_found: :blocked_resource,
    node_not_available: :blocked_resource,
    non_json_engine_result: :blocked_resource,
    non_json_manifest: :blocked_resource,
    non_json_output: :blocked_resource,
    non_json_vectors: :blocked_resource,
    ontology_manifest_unreadable: :blocked_resource,
    praxis_not_found: :blocked_resource,
    sa2a_corpus_dir_missing: :blocked_resource,
    sa2a_corpus_empty: :blocked_resource,
    sa2a_corpus_file_missing: :blocked_resource,
    sa2a_corpus_manifest_unreadable: :blocked_resource,
    sa2a_corpus_not_found: :blocked_resource,
    sa2a_graphlaw_driver_error: :blocked_resource,
    sa2a_graphlaw_non_json_stdout: :blocked_resource,
    sa2a_graphlaw_nonzero_exit: :blocked_resource,
    sa2a_graphlaw_unavailable: :blocked_resource,
    timeout: :blocked_resource,
    unexpected_engine_output: :blocked_resource,
    wasm_output_missing: :blocked_resource,
    wasm_pack_failed: :blocked_resource,
    wasm_pack_not_found: :blocked_resource,
    wasmex_instantiate_failed: :blocked_resource,
    wasmex_unavailable: :blocked_resource,
    # BLOCKED_UNKNOWN
    no_resolver: :blocked_unknown,
    resolver_failed: :blocked_unknown,
    sa2a_not_computed: :blocked_unknown,
    sa2a_upstream_not_computed: :blocked_unknown,
    # REFUSED_AUTHORITY
    authority_not_allocatable: :refused_authority,
    composition_authority_ceiling_raised: :refused_authority,
    envelope_incomplete: :refused_authority,
    llm_authority_ceiling_violated: :refused_authority,
    model_issued_budget_refused: :refused_authority,
    projection_authority_ceiling_violated: :refused_authority,
    self_grant_refused: :refused_authority,
    # REFUSED_BOUNDS
    allocation_exhausted: :refused_bounds,
    bound_reached: :refused_bounds,
    bounds_authority_ceiling_violated: :refused_bounds,
    bounds_authority_not_delegable: :refused_bounds,
    bounds_capability_invalid: :refused_bounds,
    bounds_capability_not_delegated: :refused_bounds,
    bounds_ceiling_invalid: :refused_bounds,
    bounds_ceiling_missing: :refused_bounds,
    bounds_delegation_not_narrowing: :refused_bounds,
    bounds_depth_exceeded: :refused_bounds,
    ...
    bounds_resource_unknown: :refused_bounds,
    budget_exhausted: :refused_bounds,
    dimension_not_budgeted: :refused_bounds,
    empty_budget: :refused_bounds,
    invalid_allocation_amount: :refused_bounds,
    invalid_budget_issuer: :refused_bounds,
    invalid_budget_limits: :refused_bounds,
    invalid_budget_minimums: :refused_bounds,
    plan_package_bound_contents_invalid: :refused_bounds,
    plan_package_invalid_bound: :refused_bounds,
    plan_package_production_bounds_missing: :refused_bounds,
    plan_package_resource_envelope_incomplete: :refused_bounds,
    reissue_below_consumed: :refused_bounds,
    unbounded_production_operation: :refused_bounds,
    unknown_dimension: :refused_bounds,
    # REFUSED_CAPABILITY
    composition_preconditions_unmet: :refused_capability,
    composition_self_composition: :refused_capability,
    # REFUSED_CONSEQUENCE
    admitted_artifact_mutation_refused: :refused_consequence,
    llm_effect_refused: :refused_consequence,
    refused_sparql_update_on_canonical: :refused_consequence,
    unknown_llm_effect: :refused_consequence,
    unknown_not_executable: :refused_consequence,
    # REFUSED_FALSIFIER
    refused_falsifier: :refused_falsifier,
    unknown_falsifier: :refused_falsifier,
    # REFUSED_IDENTITY
    artifact_rejected: :refused_identity,
    calver_invalid: :refused_identity,
    canonical_digest_turtle_ntriples_disagree: :refused_identity,
    compatibility_cross_identity: :refused_identity,
    compatibility_declaration_invalid: :refused_identity,
    compatibility_undeclared: :refused_identity,
    construct_package_unverifiable: :refused_identity,
    construct_projection_package_mismatch: :refused_identity,
    construct_projection_unverifiable: :refused_identity,
    graphlaw_host_id_mismatch: :refused_identity,
    graphlaw_session_replay_diverged: :refused_identity,
    graphlaw_unexpected_digest: :refused_identity,
    sa2a_corpus_digest_mismatch: :refused_identity,
    sa2a_identical_runtimes: :refused_identity,
    semantic_digest_mismatch: :refused_identity,
    wasm_digest_mismatch: :refused_identity,
    # REFUSED_META_RIGOR
    compile_back_requires_candidate: :refused_meta_rigor,
    compile_back_requires_resolution: :refused_meta_rigor,
    machinery_requires_deterministic_function: :refused_meta_rigor,
    sa2a_corpus_unmanifested_file: :refused_meta_rigor,
    unknown_machinery_kind: :refused_meta_rigor,
    # REFUSED_NAMESPACE
    concept_label_missing: :refused_namespace,
    iri_empty: :refused_namespace,
    iri_invalid_characters: :refused_namespace,
    iri_not_a_string: :refused_namespace,
    private_term_incomplete: :refused_namespace,
    runtime_semantic_individualism_refused: :refused_namespace,
    semantic_identity_absent: :refused_namespace,
    semantic_identity_unmapped: :refused_namespace,
    semantic_label_collision_unmapped: :refused_namespace,
    # REFUSED_PLAN
    plan_package_manual_edit_not_canonical: :refused_plan,
    plan_package_projection_unverifiable: :refused_plan,
    plan_package_semantic_goal_missing: :refused_plan,
    projection_manual_edit_not_canonical: :refused_plan,
    projection_ontology_mismatch: :refused_plan,
    projection_requires_admitted_graph: :refused_plan,
    projection_requires_admitted_planning_ir: :refused_plan,
    projection_source_drift: :refused_plan,
    selection_candidate_unverifiable: :refused_plan,
    selection_no_candidates: :refused_plan,
    selection_scorer_invalid: :refused_plan,
    # REFUSED_PROFILE
    selection_candidate_profile_violation: :refused_profile,
    # REFUSED_PROVENANCE
    illegal_standing_transition: :refused_provenance,
    llm_standing_claim_refused: :refused_provenance,
    non_adjacent_evidence_promotion: :refused_provenance,
    # REFUSED_RECEIPT
    actuation_conflict: :refused_receipt,
    actuation_in_flight: :refused_receipt,
    insufficient_replay_identity: :refused_receipt,
    receipt_digest_mismatch: :refused_receipt,
    unclaimed_actuation: :refused_receipt,
    # REFUSED_STRUCTURE
    canonical_digest_expected_triples: :refused_structure,
    canonical_digest_unknown_format: :refused_structure,
    construct_manufacturer_invalid_result: :refused_structure,
    construct_subject_invalid: :refused_structure,
    invalid_resolver: :refused_structure,
    llm_output_not_a_map: :refused_structure,
    manifest_unknown_schema: :refused_structure,
    ocel_missing_events_or_objects: :refused_structure,
    ocel_not_an_object: :refused_structure,
    ontology_manifest_malformed: :refused_structure,
    ontology_unparseable: :refused_structure,
    profile_payload_invalid: :refused_structure,
    sa2a_corpus_manifest_invalid: :refused_structure,
    sa2a_corpus_vector_invalid: :refused_structure,
    serialize_bnode_in_predicate: :refused_structure,
    serialize_expected_triples: :refused_structure,
    serialize_invalid_bnode_label: :refused_structure,
    serialize_invalid_datatype: :refused_structure,
    serialize_invalid_iri: :refused_structure,
    serialize_invalid_language_tag: :refused_structure,
    serialize_literal_out_of_object_position: :refused_structure,
    serialize_malformed_triple: :refused_structure,
    serialize_round_trip_mismatch: :refused_structure,
    serialize_unknown_format: :refused_structure,
    serialize_unparseable_ntriples: :refused_structure,
    serialize_unparseable_turtle: :refused_structure,
    serialize_unsupported_term: :refused_structure,
    unknown_resolver_kind: :refused_structure,
    # UNSUPPORTED_PROFILE
  ...
  # Codes that share the `code:` shape but name an ADMITTED outcome, not a
  ...
  def non_refusal_codes, do: @non_refusal_codes
