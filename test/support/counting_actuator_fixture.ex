defmodule AshA2A.Test.Fixture.KeyedActuationCounter do
  @moduledoc """
  ...
  Keyed per effect, so it is a distinct fixture from main's un-keyed
  `AshA2A.Test.Fixture.ActuationCounter` (test/support/authority_grant_fixture.ex);
  both register under their own module name and can run side by side.
  """
  use Agent
...
defmodule AshA2A.Test.Fixture.CountingActuator do
  ...
  `AshA2A.Test.Fixture.KeyedActuationCounter`).
